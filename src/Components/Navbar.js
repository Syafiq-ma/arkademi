    ...
    return(
        <div className="w-full md:px-28 px-4 xl:pb-0 pb-3" style={{background:'linear-gradient(192.48deg, #0977BE -120.7%, #1C88CE 285.22%)'}}>
            <div className="flex items-center justify-between h-14">
                <img src={logo} width={139} alt="arkademi"/>
                <label className="relative hidden w w-7/12 xl:block">
                    ...
                    <span className="absolute inset-y-0 right-0 flex items-center pr-3"><img src={searchIcon} width={14} alt="search"/></span>
                </label>
                <div className="flex items-center">
                    <img src={loveIcon} width={18} alt="love" className='mr-10'/>
            ...
            <label className="relative block w-full xl:hidden">
                ...
                <span class="absolute inset-y-0 right-0 flex items-center pr-3"><img src={searchIcon} width={14} alt="search"/></span>
            </label>
        </div>
    )
}
